package com.thrillio.sasi.datastore;

import com.thrillio.sasi.constants.BookGenre;
import com.thrillio.sasi.constants.Gender;
import com.thrillio.sasi.constants.MovieGenre;
...
public class DataStore {
	...
	//since users bookmarking we need to maintain index
	...
	private static void loadBooks() {
		...
		bookmarks[2][2] = BookmarkManager.getInstance().createBook(4002, "Light From Many Lamps", "", 1988,
				"Touchstone", new String[] { "Lillian Eichler Watson" }, BookGenre.PHILOSOPHY, 4.5);
	...
	private static void loadMovies() {
		...
		bookmarks[1][1] = BookmarkManager.getInstance().createMovie(3001, "The Grapes of Wrath", "", 1940,
				new String[] { "enry Fonda", "Jane Darwell" }, new String[] { "John Ford" }, MovieGenre.CLASSICS, 8.2);
		...
		bookmarks[1][3] = BookmarkManager.getInstance().createMovie(3003, "The Big Bang Theory", "", 2007,
				new String[] { "Kaley Cuoco", "Jim Parson" }, new String[] { "Chuck Lorre", "Bill Prady" },
	...
	private static void loadUsers() {
		...
		users[3] = UserManager.getInstance().createUser(1003, "user3@semanticsquare.com", "test", "Sara", "M",
				Gender.FEMALE, UserType.USER);
		users[4] = UserManager.getInstance().createUser(1004, "user4@semanticsquare.com", "test", "Sasikumar", "K",
				Gender.MALE, UserType.USER);
